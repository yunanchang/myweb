...
if (isset($_SESSION['user']) && $_SESSION['user'] != 'admin') {
  // 如果用戶未登錄，重定向到登錄頁面或其他地方
  header("Location: 無法進入"); // 請根據實際情況更改重定向的地址
  exit(); // 重定向後終止腳本執行
}
?>
<!DOCTYPE html>
...
<body>
  <div class="container-fulid">
    ...
    <ul class="nav">
      ...
      <li class="nav-item mt-1">
        <a class="nav-link" href="?do=marquee">動態文字</a>
      </li>
      <!-- 找出user name -->
      <?php
  ...
  if (queryValue.trim() === "") {
    ...
    var targetURL = "./index.php?do=search&value=" + encodeURIComponent(queryValue);
